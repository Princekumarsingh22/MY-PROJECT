			...
			<section class="page-top">
				<div class="container">
					<div class="page-top-in">
						<h2><span>Proerty with Contact us</span></h2>
					</div>
				</div>
			</section>
			<!-- End page top -->
				...
				<div class="row">
					<div class="col-md-9 content">
						...
						<section class="pgl-featured">
							...
							<div class="row">
								<div class="owl-carousel pgl-pro-slide" data-plugin-options='{"items": 3, "singleItem": false, "autoPlay": false, "pagination": false}'>
