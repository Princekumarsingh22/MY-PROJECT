									...
									<div class="row pgl-midnarrow-row">
										<div class="col-xs-3">
											<div class="img-thumbnail-medium">
												<a href="agentprofile1.php"><img src="images/agents/temp-agent1.jpg" class="img-responsive" alt=""></a>
											</div>
										</div>
										<div class="col-xs-9">
											<div class="pgl-agent-info">
												<small>NO.2</small>
												<h4><a href="agentprofile1.php">Rahul Builder</a></h4>
												<address>
												...
												<p>We offer services throughout the complete Real Estate Value Chain. Ours is a team of professional dealer-brokers that specialize in finalizing deals for the sale purchase rent and lease of properties in Real Estate industry. </p>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="pgl-property">
										<div class="property-thumb-info">
											...
											<div class="property-thumb-info-content">
												<h3><a href="property-detail.html">3 BHK Flats for Sale</a></h3>
												<address>Dwarka Sector 23, Delhi  Land in Sales</address>
											</div>
								...
								<div class="col-xs-6 col-md-3 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											...
											<div class="property-thumb-info-content">
												<h3><a href="property-detail.html">3 BHK Flats for Sale</a></h3>
												<address>Dwarka Sector 3, Delhi City Land in Sales</address>
											</div>
											<div class="amenities clearfix">
												<ul class="pull-left">
													<li><strong>Area:</strong> 450<sup>m2</sup></li>
