...
<head>
  ...
  <link rel="stylesheet" href="signInRole.css">
</head>
<style>
  html {
    height: 100%;
  ...
  .signInRole {
    ...
    overflow-x: auto;
    overflow-y: auto;
    background-color: rgba(138, 194, 177, 1);
    width: 1366.00px;
    height: 768.00px;
    left: 0px;
    top: 0px;
  ...
  .signInRole .rectangle1 {
    ...
    border-bottom-left-radius: 50.00px;
  ...
  .signInRole .findYourIdealProperty {
    position: absolute;
    box-sizing: content-box;
    -ms-transform: rotate(0.00deg);
    -webkit-transform: rotate(0.00deg);
  ...
  .signInRole .xc4702f98 {
    ...
    -webkit-transform-origin: center;
    transform-origin: center;
    background-image: url("image/xc4702f98.png");
  ...
  .signInRole .filers .filersbox {
    ...
    padding-bottom: 0.00px;
    padding-left: 0.00px;
    background-color: rgba(30, 78, 64, 1);
    border-bottom-color: rgba(112, 112, 112, 1);
    border-bottom-style: none;
    border-bottom-width: 1.00px;
    border-left-color: rgba(112, 112, 112, 1);
  ...
  .signInRole .iconAwesomeHouseDamage {
    position: absolute;
    box-sizing: content-box;
    -ms-transform: rotate(0.00deg);
    -webkit-transform: rotate(0.00deg);
  ...
  .signInRole .iconAwesomeEyeSlash {
    position: absolute;
    box-sizing: content-box;
    -ms-transform: rotate(0.00deg);
    -webkit-transform: rotate(0.00deg);
...
<body>
  ...
  <div class="signInRole">
    ...
    <form action="code.php" method="POST" name="signinform">
      <!-- input data fields -->
      <input type="email" name="email" class="emailAddress" placeholder="Email ID: " required>
      <input type="password" name="password" class="password" placeholder="Password: " required>
      <button class="b" name="login_btn" type="submit">
        <div class="filers">
    ...
    <div class="logo"><img src="image/logo.png" alt="LOL"></div>
