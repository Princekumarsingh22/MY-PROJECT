      ...
      <div class="col-md-8">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item">
              <img src="image/sell3/balcony3.jpg" alt="lol1">
              <div class="carousel-caption">
                BALCONY
              </div>
            </div>
            <div class="item">
              <img src="image/sell3/bedroom3.1.jpg" alt="lol2">
              <div class="carousel-caption">
                BEDROOM~1
              </div>
            </div>
            <div class="item">
              <img src="image/sell3/bedroom3.jpg" alt="lol3">
              <div class="carousel-caption">
                BEDROOM~2
              </div>
            </div>
            <div class="item">
              <img src="image/sell3/diningroom3.jpg" alt="lol4">
              <div class="carousel-caption">
                DININGROOM
              </div>
            </div>
            <div class="item active">
              <img src="image/sell3/exterior3.jpg" alt="lol5">
              <div class="carousel-caption">
                EXTERIOR
              </div>
            </div>
            <div class="item">
              <img src="image/sell3/kitchen3.jpg" alt="lol6">
              <div class="carousel-caption">
                KITCHEN
              </div>
            </div>
            <div class="item">
              <img src="image/sell3/livingroom3.jpg" alt="lol7">
              <div class="carousel-caption">
                LIVINGROOM
              </div>
            </div>
      ...
      <div class="col-md-10">
        <section>
          ...
          <details>
            ...
            <p>About Vasundhara La Greeno

                Ashok Nagar (at four lane Patna main bypass), the fastest growing suburb, is easily the destination of the future with La Greeno, as it's future land mark. Beside open green spaces, clear skies and unpolluted fresh air, that make La Greeno a preferred choice for quaint residence, it enjoys the distinction of having a strategic location advantage.

                2.5 km from Patna Junction
                1 km from Bus Stand
                4.5 km from Airport
                0.8 km from Patna Central School
                1 km from Ford Hospital
                2.5 km from Planetarium
                2.1 km from Exhibition Road Chouraha
                2.5 km from Dak Bunglow Chouraha
                3.5 km from Boring Road Chouraha
                2.9 km from Hight Court
                3 km from Secretariat
                1 km from Doctor's Colony
            </p>
          </details>
