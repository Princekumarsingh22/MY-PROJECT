...
<section>
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <h2>764 W. Manor Station Drive East</h2>
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item">
              <img src="image/sell2/balcony2.jpg" alt="lol1">
              <div class="carousel-caption">
                BALCONY
              </div>
            </div>
            <div class="item">
              <img src="image/sell2/bedroom2.1.jpg" alt="lol2">
              <div class="carousel-caption">
                BEDROOM~1
              </div>
            </div>
            <div class="item">
              <img src="image/sell2/bedroom2.jpg" alt="lol3">
              <div class="carousel-caption">
                BEDROOM~2
              </div>
            </div>
            ...
            <div class="item active">
              <img src="image/sell2/exterior2.jpg" alt="lol5">
              <div class="carousel-caption">
                EXTERIOR
              </div>
            </div>
            <div class="item">
              <img src="image/sell2/kitchen2.jpg" alt="lol6">
              <div class="carousel-caption">
                KITCHEN
              </div>
            </div>
            <div class="item">
              <img src="image/sell2/livingroom2.jpg" alt="lol7">
              <div class="carousel-caption">
                LIVINGROOM
              </div>
            </div>
