...
<body> -->
    <!-- NAVBAR SECTION -->
    <section class="banner-part1">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-default navbar-mobile bootsnav on">
                        <a class="navbar-brand" href="#"><img src="image/logo.png" alt="logo" class="logo"></a>
                            ...
                            <ul class="nav navbar-nav" data-in="fadeInDown" data-out="fadeOutUp">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                        data-hover="Shortcodes">buy <span></span></a>
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                        data-hover="Shortcodes">rent <span></span></a>
                                ...
                                <li class="dropdown">
                                <a href="contact.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="Pages">Help
                                    <span></span></a>
...
<!--                                                                                    
 __________   __________   ______________     ___________   __________    ___________   | \      | 
|            |          |     |          |   |              |         |  |              |  \     |
|            |          |     |          |   |              |         |  |              |   \    |
|            |          |     |          |   |___________   |_________|  |___________   |    \   |
|            |          |     |          |   |              |            |              |     \  |
|            |          |     |          |   |              |            |              |      \ |
|__________  |__________|  ___|__________|   |___________   |            |___________   |       \|
 -->