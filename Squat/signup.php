    ...
    <div class="login-dark" style="height: 695px;">
        <form action="code.php" method="POST">
            ...
            <div class="form-group">
                <input class="form-control" type="name" name="unm" placeholder="Your Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input class="form-control" type="password" name="pnm" placeholder="Password">
            </div>
            <div class="form-group">
                <input class="form-control" type="password" name="repnm" placeholder="Re-Type Password">
            </div>
            <div class="form-group">
